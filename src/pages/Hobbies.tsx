...
export default function Hobbies() {
  ...
  const hobbies = [
    {
      name: 'Figure Skating',
      desc: 'I\'m an adult figure skater, and it\'s never too late to start chasing a passion. I\'m currently working towards my STAR 4 ice dance and my freeskate program.',
